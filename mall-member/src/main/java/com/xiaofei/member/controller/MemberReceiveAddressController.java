...
public class MemberReceiveAddressController {
    ...
    public ResponseResult<String> DeleteReceiveAddressById(@RequestHeader(name = CacheConstants.DETAILS_USER_ID) Long userId,
    ...
    public ResponseResult<MemberReceiveAddressEntity> getReceiveAddressById(@RequestHeader(name = CacheConstants.DETAILS_USER_ID) Long userId,
                                                                            @PathVariable("id") Integer id) {
